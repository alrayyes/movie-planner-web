...
import type { Picklists } from "../src/lib/caldav/types";
...
async function connect(page: Page, initialPicklists?: Picklists) {
  const server = mockCaldavServer(page, CREDENTIALS["caldav-url"], [], initialPicklists);
  await page.goto("/");
